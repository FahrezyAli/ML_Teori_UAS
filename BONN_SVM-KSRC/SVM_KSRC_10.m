...
best_feature = [1023,1023,1023,1023,1023,1023,1023];
Test = 7;
tennum = 10;
    ...
    for ten = 1:10
        ...
        for j = 1:10
            ...
            supportvector = [trainsvm(SVMModel.IsSupportVector,1),trainsvm(SVMModel.IsSupportVector,2),...
                ...
                ,trainsvm(SVMModel.IsSupportVector,6),trainsvm(SVMModel.IsSupportVector,7),trainsvm(SVMModel.IsSupportVector,8),trainsvm(SVMModel.IsSupportVector,9),trainsvm(SVMModel.IsSupportVector,10)];

...
best_feature = [985,971,985,980,969,982,1010];
Test = 7;
tennum = 10;
SvmLabel = label_all(1:10);
testrange = Case{Test}; 
testnum = 10+length(testrange)/10;
for sl = best_feature(Test)   % 968:1012
    ...
    for ten = 1:10
        ...
        for j = 1:10
            ...
            supportvector = [trainsvm(SVMModel.IsSupportVector,1),trainsvm(SVMModel.IsSupportVector,2),...
                ...
                ,trainsvm(SVMModel.IsSupportVector,6),trainsvm(SVMModel.IsSupportVector,7),trainsvm(SVMModel.IsSupportVector,8)];

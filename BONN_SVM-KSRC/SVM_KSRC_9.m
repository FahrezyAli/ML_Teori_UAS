...
for sl = best_feature(Test)   %1013:1022  
    ...
    for ten = 1:10
        ...
        for j = 1:10
             ...
             supportvector = [trainsvm(SVMModel.IsSupportVector,1),trainsvm(SVMModel.IsSupportVector,2),...
                 ...
                 ,trainsvm(SVMModel.IsSupportVector,6),trainsvm(SVMModel.IsSupportVector,7),trainsvm(SVMModel.IsSupportVector,8),trainsvm(SVMModel.IsSupportVector,9)];
            ...
            [in7,on7] = inpolygon(testsvm(:,7),testsvm(:,8),supportarea7(:,1),supportarea7(:,2));
             ...
             in = (in1&in2)&(in3&in4)&(in5&in6)&in7&in8;
              on = (on1&on2)&(on3&on4)&(on5&on6)&on7&on8;

             A = traindata(:,22:data_len-1)';
             testSC = testdata(:,22:data_len-1)';
             KAA = Gsker(A,A,p); 
             for i = 1:testnum
